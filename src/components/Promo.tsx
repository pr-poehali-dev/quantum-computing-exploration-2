...
export default function Promo() {
  ...
  const faq = [
    ...
    },
    {
      ...
      a: "У каждой участницы будет своё личное пространство. Если хочешь жить одна — выбираешь отдельную спальню. Если хочешь сэкономить или уже знаешь, с кем хочешь делить комнату — можно заселиться вдвоём.",
    },
    {
